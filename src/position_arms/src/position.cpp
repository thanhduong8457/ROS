...
#include "position_arms/PositionArm.h"
...
int main(int argc, char** argv)
{
  ...
  ros::Publisher chatter_pub = nh.advertise<position_arms::PositionArm>("thanhduong", 1000);
  ros::Rate loop_rate(50);

  while (ros::ok())
  {
    position_arms::PositionArm PositionArm;
