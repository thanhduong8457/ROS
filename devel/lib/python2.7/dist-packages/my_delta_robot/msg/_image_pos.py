...
"""autogenerated by genpy from my_delta_robot/image_pos.msg. Do not edit."""
import codecs
import sys
...
class image_pos(genpy.Message):
  _md5sum = "6e41facbac095be2059fd056239eeb7d"
  _type = "my_delta_robot/image_pos"
...
int64[] type"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(image_pos, self).__init__(*args, **kwds)
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.type = numpy.frombuffer(str[start:end], dtype=numpy.int64, count=length)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
