...
(cl:defmethod cl:initialize-instance :after ((m <angulo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'angulo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_delta_robot-msg:<angulo> is deprecated: use my_delta_robot-msg:angulo instead.")))

(cl:ensure-generic-function 'theta1-val :lambda-list '(m))
(cl:defmethod theta1-val ((m <angulo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_delta_robot-msg:theta1-val is deprecated.  Use my_delta_robot-msg:theta1 instead.")
  (theta1 m))

(cl:ensure-generic-function 'theta2-val :lambda-list '(m))
(cl:defmethod theta2-val ((m <angulo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_delta_robot-msg:theta2-val is deprecated.  Use my_delta_robot-msg:theta2 instead.")
  (theta2 m))

(cl:ensure-generic-function 'theta3-val :lambda-list '(m))
(cl:defmethod theta3-val ((m <angulo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_delta_robot-msg:theta3-val is deprecated.  Use my_delta_robot-msg:theta3 instead.")
  (theta3 m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<angulo>)))
  ...
  (cl:format cl:nil "float32 theta1~%float32 theta2~%float32 theta3~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'angulo)))
  "Returns full string definition for message of type 'angulo"
  (cl:format cl:nil "float32 theta1~%float32 theta2~%float32 theta3~%~%~%"))
